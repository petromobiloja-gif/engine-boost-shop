...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "PetroMobi — Óleos lubrificantes e produtos automotivos" },
      ...
      { property: "og:title", content: "PetroMobi — Óleos lubrificantes e produtos automotivos" },
      ...
      { name: "twitter:title", content: "PetroMobi — Óleos lubrificantes e produtos automotivos" },
